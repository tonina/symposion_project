"""
Django settings for symposion_project project.
...
SECRET_KEY = 'z8xeo$%8m!#!u@e_z%=ahd64w%-k%!2*x1div68e3ph!1^$4*w'
...
WSGI_APPLICATION = 'symposion_project.wsgi.application'
